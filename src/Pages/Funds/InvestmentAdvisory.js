...
import Investmentadvisoryfund from '../../components/Founds/Investmentadvisoryfund';
...
export default function InvestmentAdvisory() {
  ...
  return (
   ...
   >
       ...
       <MiniBanner heading={'Investment Advisory'} bannerImage={BannerPic} imageSizePercentage={'50%'} />
      
   </Stack>
   <FundNavBar/>
   <Investmentadvisoryfund/>
