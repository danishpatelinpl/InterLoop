    ...
    <>
      <Stack 
        ...
        >
            ...
            <MiniBanner textTransform={'capitalize'} heading={'Product Brochures'} bannerImage={BannerPic} imageSizePercentage={'50%'} />
        ...
        >
          <Stack gap={9}>
            <Box >
              <Heading mb={'4'} textTransform={'uppercase'}>fmr iamlef</Heading>
              <Link  
               bg={'#f79e22'}
