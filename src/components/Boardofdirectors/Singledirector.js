...
export default function Singledirector({ Directorimg,DirectorName, Directordesignation, Directordetail, DirectorAdditionalInfo }) {
    return (
        <Stack>
                        ...
                        <GridItem colSpan={{ base: '12', md: '8' }} >
                            ...
                            <Box boxShadow='lg' p='6' rounded='md'>
                                <Text
                                    ...
                                    fontWeight={'400'}
                                    color={'#0d182b'}
                                    lineHeight={{ md: '35px', base: '20px' }}>{DirectorAdditionalInfo}</Text>
                            </Box>
                        </GridItem>
                    </Grid>
                </Stack>
